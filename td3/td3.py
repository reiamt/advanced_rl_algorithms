...
class Agent:
    def __init__(self,  alpha, beta, input_dims, tau, env, 
        ...
        self.noise = noise
        self.update_network_parameters(tau=1) #hard copy of network weights to target networks on first iteration
    ...
    def learn(self):
        ...
        #update to critic, every iteration
        ...
        #loss for actor network, only every other iteration

...
class CriticNetwork(nn.Module):
    def __init__(self, beta, input_dims, n_actions, name='critic', 
...
class ActorNetwork(nn.Module):
    ...
    def forward(self, state):
        ...
        #cut sigma, as dist should not have big tails
    ...
    def sample_normal(self, state, reparameterize=True):
        ...
        if reparameterize:
            actions = probabilities.rsample() #sample with some noise
        else:
